...
public class DrugUpcServiceManager {
    //域名
    private static final String baseUrl="https://api.upcitemdb.com";
    //连接超时
    ...
    //单例模式
    private static DrugUpcServiceManager instance;
    private Retrofit retrofit;
    private DrugUpcServiceManager(){
        //设置缓存目录
    ...
    //单例，懒汉式线程安全
    public static synchronized DrugUpcServiceManager getInstance(){
        if(instance==null)
            instance=new DrugUpcServiceManager();
        return instance;
    }
